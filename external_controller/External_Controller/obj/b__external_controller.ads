...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_external_controller" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#77ba3fb9#;
   pragma Export (C, u00001, "external_controllerB");
   ...
   u00123 : constant Version_32 := 16#521a5b9a#;
   pragma Export (C, u00123, "lane_detectionB");
   u00124 : constant Version_32 := 16#6ebd4f29#;
   pragma Export (C, u00124, "lane_detectionS");
   u00125 : constant Version_32 := 16#38c7c529#;
   pragma Export (C, u00125, "roadmarker_functionsB");
   u00126 : constant Version_32 := 16#0febe8a2#;
   pragma Export (C, u00126, "roadmarker_functionsS");
   u00127 : constant Version_32 := 16#4f04e3f2#;
   pragma Export (C, u00127, "system__taskingB");
   u00128 : constant Version_32 := 16#76fd1509#;
   pragma Export (C, u00128, "system__taskingS");
   u00129 : constant Version_32 := 16#5901abf2#;
   pragma Export (C, u00129, "system__task_primitivesS");
   u00130 : constant Version_32 := 16#5bbb030d#;
   pragma Export (C, u00130, "system__os_interfaceS");
   u00131 : constant Version_32 := 16#1d638357#;
   pragma Export (C, u00131, "interfaces__c__stringsB");
   u00132 : constant Version_32 := 16#603c1c44#;
   pragma Export (C, u00132, "interfaces__c__stringsS");
   u00133 : constant Version_32 := 16#c1984f17#;
   pragma Export (C, u00133, "system__task_primitives__operationsB");
   u00134 : constant Version_32 := 16#17a57953#;
   ...
   u00138 : constant Version_32 := 16#b66bc35d#;
   pragma Export (C, u00138, "system__interrupt_managementS");
   u00139 : constant Version_32 := 16#f65595cf#;
   pragma Export (C, u00139, "system__multiprocessorsB");
   u00140 : constant Version_32 := 16#0a0c1e4b#;
   ...
   u00142 : constant Version_32 := 16#c2531eac#;
   pragma Export (C, u00142, "system__task_infoS");
   u00143 : constant Version_32 := 16#e5a48551#;
   pragma Export (C, u00143, "system__tasking__debugB");
   u00144 : constant Version_32 := 16#48f9280e#;
   ...
   u00148 : constant Version_32 := 16#39d0dd9d#;
   ...
   u00150 : constant Version_32 := 16#53ec87f8#;
   ...
   u00153 : constant Version_32 := 16#1e07ca19#;
   pragma Export (C, u00153, "system__tasking__rendezvousB");
   u00154 : constant Version_32 := 16#5618a4d0#;
   pragma Export (C, u00154, "system__tasking__rendezvousS");
   ...
   u00157 : constant Version_32 := 16#e49898fa#;
   ...
   u00173 : constant Version_32 := 16#43cda1ce#;
   ...
   u00177 : constant Version_32 := 16#9cbb0d81#;
   pragma Export (C, u00177, "system__tasking__stagesB");
   u00178 : constant Version_32 := 16#5fc08d5c#;
   pragma Export (C, u00178, "system__tasking__stagesS");
   u00179 : constant Version_32 := 16#64176fe3#;
   pragma Export (C, u00179, "ada__real_timeB");
   u00180 : constant Version_32 := 16#69ea8064#;
   pragma Export (C, u00180, "ada__real_timeS");
   u00181 : constant Version_32 := 16#e8b78747#;
   pragma Export (C, u00181, "motor_controllerB");
   u00182 : constant Version_32 := 16#91242745#;
   pragma Export (C, u00182, "motor_controllerS");
   u00183 : constant Version_32 := 16#8aa4f090#;
   pragma Export (C, u00183, "system__img_realB");
   u00184 : constant Version_32 := 16#f508d0da#;
   pragma Export (C, u00184, "system__img_realS");
   ...
   u00189 : constant Version_32 := 16#6c930c55#;
   pragma Export (C, u00189, "wc2ecB");
   u00190 : constant Version_32 := 16#859fd4d5#;
   pragma Export (C, u00190, "wc2ecS");
   ...
   u00193 : constant Version_32 := 16#c164a034#;
   pragma Export (C, u00193, "ada__containers__hash_tablesS");
   u00194 : constant Version_32 := 16#bcec81df#;
   pragma Export (C, u00194, "ada__containers__helpersB");
   u00195 : constant Version_32 := 16#4adfc5eb#;
   pragma Export (C, u00195, "ada__containers__helpersS");
   ...
   u00200 : constant Version_32 := 16#bf363ed2#;
   pragma Export (C, u00200, "ada__strings__fixedB");
   u00201 : constant Version_32 := 16#fec1aafc#;
   ...
   u00204 : constant Version_32 := 16#75de1dee#;
   pragma Export (C, u00204, "ada__strings__hashB");
   u00205 : constant Version_32 := 16#3655ad4c#;
   pragma Export (C, u00205, "ada__strings__hashS");
   u00206 : constant Version_32 := 16#bc1efb7f#;
   pragma Export (C, u00206, "distance_sensor_pB");
   u00207 : constant Version_32 := 16#a5f9ef28#;
   pragma Export (C, u00207, "distance_sensor_pS");
   u00208 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00208, "gnatS");
   u00209 : constant Version_32 := 16#f9e26491#;
   pragma Export (C, u00209, "gnat__socketsB");
   u00210 : constant Version_32 := 16#4556a824#;
   pragma Export (C, u00210, "gnat__socketsS");
   u00211 : constant Version_32 := 16#f361eb63#;
   pragma Export (C, u00211, "gnat__sockets__linker_optionsS");
   u00212 : constant Version_32 := 16#c4cbe2a2#;
   pragma Export (C, u00212, "gnat__sockets__thinB");
   u00213 : constant Version_32 := 16#5692482d#;
   pragma Export (C, u00213, "gnat__sockets__thinS");
   u00214 : constant Version_32 := 16#c21c4ce8#;
   pragma Export (C, u00214, "gnat__sockets__thin_commonB");
   u00215 : constant Version_32 := 16#ae33425a#;
   ...
   u00217 : constant Version_32 := 16#2bc0d4ea#;
   pragma Export (C, u00217, "system__communicationS");
   u00218 : constant Version_32 := 16#5a895de2#;
   pragma Export (C, u00218, "system__pool_globalB");
   u00219 : constant Version_32 := 16#7141203e#;
   pragma Export (C, u00219, "system__pool_globalS");
   u00220 : constant Version_32 := 16#e31b7c4e#;
   pragma Export (C, u00220, "system__memoryB");
   u00221 : constant Version_32 := 16#6bdde70c#;
   pragma Export (C, u00221, "system__memoryS");
   u00222 : constant Version_32 := 16#6d4d969a#;
   pragma Export (C, u00222, "system__storage_poolsB");
   u00223 : constant Version_32 := 16#114d1f95#;
   pragma Export (C, u00223, "system__storage_poolsS");
   u00224 : constant Version_32 := 16#637ab3c9#;
   pragma Export (C, u00224, "system__pool_sizeB");
   u00225 : constant Version_32 := 16#338ec961#;
   pragma Export (C, u00225, "system__pool_sizeS");
   u00226 : constant Version_32 := 16#0f9783a4#;
   pragma Export (C, u00226, "system__val_intB");
   u00227 : constant Version_32 := 16#875fe85b#;
   pragma Export (C, u00227, "system__val_intS");
   u00228 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00228, "system__val_unsB");
   u00229 : constant Version_32 := 16#33208002#;
   pragma Export (C, u00229, "system__val_unsS");
   u00230 : constant Version_32 := 16#d96e3c40#;
   ...
   u00234 : constant Version_32 := 16#c86f510c#;
   pragma Export (C, u00234, "system__os_constantsS");
   u00235 : constant Version_32 := 16#1c3cc708#;
   pragma Export (C, u00235, "ring_bufferB");
   u00236 : constant Version_32 := 16#f6e14d76#;
   pragma Export (C, u00236, "ring_bufferS");
   u00237 : constant Version_32 := 16#2e260032#;
   pragma Export (C, u00237, "system__storage_pools__subpoolsB");
   u00238 : constant Version_32 := 16#cc5a1856#;
   pragma Export (C, u00238, "system__storage_pools__subpoolsS");
   u00239 : constant Version_32 := 16#84042202#;
   pragma Export (C, u00239, "system__storage_pools__subpools__finalizationB");
   u00240 : constant Version_32 := 16#fe2f4b3a#;
   pragma Export (C, u00240, "system__storage_pools__subpools__finalizationS");
   u00241 : constant Version_32 := 16#54aee175#;
   ...
   u00243 : constant Version_32 := 16#0da40211#;
   pragma Export (C, u00243, "roadmarkerB");
   u00244 : constant Version_32 := 16#b5a809a4#;
   pragma Export (C, u00244, "roadmarkerS");

package Motor_Controller is
   ...
   type Motor_ID_T is (MOTOR_FRONT_LEFT, MOTOR_FRONT_RIGHT, MOTOR_BACK_LEFT, MOTOR_BACK_RIGHT);

   type set_motor_value_procedure_t is access procedure (ID: Motor_ID_T;
                                                         Value : Long_Float);

...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_lane_detection" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#07e5dc92#;
   pragma Export (C, u00001, "test_lane_detectionB");
   ...
   u00112 : constant Version_32 := 16#03e83e15#;
   ...
   u00123 : constant Version_32 := 16#e8b78747#;
   pragma Export (C, u00123, "motor_controllerB");
   u00124 : constant Version_32 := 16#91242745#;
   pragma Export (C, u00124, "motor_controllerS");
   ...
   u00133 : constant Version_32 := 16#1e07ca19#;
   pragma Export (C, u00133, "system__tasking__rendezvousB");
   u00134 : constant Version_32 := 16#5618a4d0#;
   pragma Export (C, u00134, "system__tasking__rendezvousS");
   u00135 : constant Version_32 := 16#100eaf58#;
   pragma Export (C, u00135, "system__restrictionsB");
   u00136 : constant Version_32 := 16#79d25869#;
   pragma Export (C, u00136, "system__restrictionsS");
   u00137 : constant Version_32 := 16#5901abf2#;
   pragma Export (C, u00137, "system__task_primitivesS");
   u00138 : constant Version_32 := 16#5bbb030d#;
   ...
   u00153 : constant Version_32 := 16#e5a48551#;
   pragma Export (C, u00153, "system__tasking__debugB");
   u00154 : constant Version_32 := 16#48f9280e#;
   ...
   u00169 : constant Version_32 := 16#0f96c370#;
   ...
   u00173 : constant Version_32 := 16#ff485338#;
   ...
   u00177 : constant Version_32 := 16#43cda1ce#;
   pragma Export (C, u00177, "system__tasking__queuingB");
   u00178 : constant Version_32 := 16#6dba2805#;
   ...
   u00181 : constant Version_32 := 16#9cbb0d81#;
   pragma Export (C, u00181, "system__tasking__stagesB");
   u00182 : constant Version_32 := 16#5fc08d5c#;
   pragma Export (C, u00182, "system__tasking__stagesS");
   u00183 : constant Version_32 := 16#64176fe3#;
   pragma Export (C, u00183, "ada__real_timeB");
   u00184 : constant Version_32 := 16#69ea8064#;
   pragma Export (C, u00184, "ada__real_timeS");
   u00185 : constant Version_32 := 16#6c930c55#;
   pragma Export (C, u00185, "wc2ecB");
   u00186 : constant Version_32 := 16#859fd4d5#;
   pragma Export (C, u00186, "wc2ecS");
   ...
   u00189 : constant Version_32 := 16#c164a034#;
   pragma Export (C, u00189, "ada__containers__hash_tablesS");
   u00190 : constant Version_32 := 16#bcec81df#;
   pragma Export (C, u00190, "ada__containers__helpersB");
   u00191 : constant Version_32 := 16#4adfc5eb#;
   pragma Export (C, u00191, "ada__containers__helpersS");
   u00192 : constant Version_32 := 16#020a3f4d#;
   pragma Export (C, u00192, "system__atomic_countersB");
   u00193 : constant Version_32 := 16#86fcacb5#;
   pragma Export (C, u00193, "system__atomic_countersS");
   u00194 : constant Version_32 := 16#c24eaf4d#;
   pragma Export (C, u00194, "ada__containers__prime_numbersB");
   u00195 : constant Version_32 := 16#6d3af8ed#;
   pragma Export (C, u00195, "ada__containers__prime_numbersS");
   u00196 : constant Version_32 := 16#bf363ed2#;
   ...
   u00198 : constant Version_32 := 16#144f64ae#;
   pragma Export (C, u00198, "ada__strings__searchB");
   u00199 : constant Version_32 := 16#c1ab8667#;
   pragma Export (C, u00199, "ada__strings__searchS");
   ...
   u00202 : constant Version_32 := 16#bc1efb7f#;
   pragma Export (C, u00202, "distance_sensor_pB");
   u00203 : constant Version_32 := 16#a5f9ef28#;
   pragma Export (C, u00203, "distance_sensor_pS");
   u00204 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00204, "gnatS");
   u00205 : constant Version_32 := 16#f9e26491#;
   pragma Export (C, u00205, "gnat__socketsB");
   u00206 : constant Version_32 := 16#4556a824#;
   pragma Export (C, u00206, "gnat__socketsS");
   u00207 : constant Version_32 := 16#f361eb63#;
   pragma Export (C, u00207, "gnat__sockets__linker_optionsS");
   u00208 : constant Version_32 := 16#c4cbe2a2#;
   pragma Export (C, u00208, "gnat__sockets__thinB");
   u00209 : constant Version_32 := 16#5692482d#;
   pragma Export (C, u00209, "gnat__sockets__thinS");
   u00210 : constant Version_32 := 16#c21c4ce8#;
   pragma Export (C, u00210, "gnat__sockets__thin_commonB");
   u00211 : constant Version_32 := 16#ae33425a#;
   pragma Export (C, u00211, "gnat__sockets__thin_commonS");
   u00212 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00212, "system__communicationB");
   u00213 : constant Version_32 := 16#2bc0d4ea#;
   pragma Export (C, u00213, "system__communicationS");
   u00214 : constant Version_32 := 16#5a895de2#;
   pragma Export (C, u00214, "system__pool_globalB");
   u00215 : constant Version_32 := 16#7141203e#;
   ...
   u00218 : constant Version_32 := 16#6d4d969a#;
   pragma Export (C, u00218, "system__storage_poolsB");
   u00219 : constant Version_32 := 16#114d1f95#;
   pragma Export (C, u00219, "system__storage_poolsS");
   u00220 : constant Version_32 := 16#637ab3c9#;
   pragma Export (C, u00220, "system__pool_sizeB");
   u00221 : constant Version_32 := 16#338ec961#;
   pragma Export (C, u00221, "system__pool_sizeS");
   u00222 : constant Version_32 := 16#0f9783a4#;
   pragma Export (C, u00222, "system__val_intB");
   u00223 : constant Version_32 := 16#875fe85b#;
   pragma Export (C, u00223, "system__val_intS");
   u00224 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00224, "system__val_unsB");
   u00225 : constant Version_32 := 16#33208002#;
   pragma Export (C, u00225, "system__val_unsS");
   u00226 : constant Version_32 := 16#d96e3c40#;
   pragma Export (C, u00226, "system__finalization_mastersB");
   u00227 : constant Version_32 := 16#695cb8f2#;
   ...
   u00230 : constant Version_32 := 16#c86f510c#;
   pragma Export (C, u00230, "system__os_constantsS");
   u00231 : constant Version_32 := 16#1c3cc708#;
   pragma Export (C, u00231, "ring_bufferB");
   u00232 : constant Version_32 := 16#f6e14d76#;
   pragma Export (C, u00232, "ring_bufferS");
   u00233 : constant Version_32 := 16#2e260032#;
   pragma Export (C, u00233, "system__storage_pools__subpoolsB");
   u00234 : constant Version_32 := 16#cc5a1856#;
   pragma Export (C, u00234, "system__storage_pools__subpoolsS");
   u00235 : constant Version_32 := 16#84042202#;
   ...
   u00237 : constant Version_32 := 16#54aee175#;
   pragma Export (C, u00237, "system__strings__stream_opsB");
   u00238 : constant Version_32 := 16#ec029138#;
   pragma Export (C, u00238, "system__strings__stream_opsS");

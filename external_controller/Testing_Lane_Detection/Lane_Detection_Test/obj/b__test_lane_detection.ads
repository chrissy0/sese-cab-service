...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#54194486#;
   ...
   u00161 : constant Version_32 := 16#429e541b#;
   pragma Export (C, u00161, "lane_detection_suiteB");
   u00162 : constant Version_32 := 16#cf34b2dc#;
   pragma Export (C, u00162, "lane_detection_suiteS");
   ...
   u00167 : constant Version_32 := 16#1e5969c0#;
   pragma Export (C, u00167, "lane_detection_testB");
   u00168 : constant Version_32 := 16#ff1b9ed1#;
   pragma Export (C, u00168, "lane_detection_testS");
   ...
   u00224 : constant Version_32 := 16#d34a5c03#;
   pragma Export (C, u00224, "lane_detectionB");
   u00225 : constant Version_32 := 16#d05c1dd0#;
   pragma Export (C, u00225, "lane_detectionS");
   ...
   u00228 : constant Version_32 := 16#1e07ca19#;
   pragma Export (C, u00228, "system__tasking__rendezvousB");
   u00229 : constant Version_32 := 16#5618a4d0#;
   pragma Export (C, u00229, "system__tasking__rendezvousS");
   u00230 : constant Version_32 := 16#e49898fa#;
   pragma Export (C, u00230, "system__tasking__entry_callsB");
   u00231 : constant Version_32 := 16#6342024e#;
   pragma Export (C, u00231, "system__tasking__entry_callsS");
   u00232 : constant Version_32 := 16#0eed7110#;
   pragma Export (C, u00232, "system__tasking__protected_objects__operationsB");
   u00233 : constant Version_32 := 16#ba36ad85#;
   pragma Export (C, u00233, "system__tasking__protected_objects__operationsS");
   u00234 : constant Version_32 := 16#9cbb0d81#;
   pragma Export (C, u00234, "system__tasking__stagesB");
   u00235 : constant Version_32 := 16#5fc08d5c#;
   pragma Export (C, u00235, "system__tasking__stagesS");
   ...
   --  lane_detection%s
   --  lane_detection%b
   --  lane_detection_test%s
   --  lane_detection_test%b
   --  lane_detection_suite%s
   --  lane_detection_suite%b

...
package body Roadmarker is
   ...
   procedure retrieve_all_sensor_values ------------Spark can't operate in this function because of 'access'
     (
   ...
   procedure empty_history(history: in out Road_Marker_History_T) ------------verification(3)
   is
   begin
   ...
   function calculate_output ------------Spark can't operate in this function because of 'in out'
     (
      all_sensor_values : All_Sensor_Values_Array_T;
